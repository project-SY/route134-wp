		...
		<div class="content-column">
			<div id="category">
				<div class="content-column-block">
					...
					<p class="discription">
						湘南のビーチ湘南のビーチ湘南のビーチ湘南のビーチ湘南のビーチ
					</p>
				</div>
				<!-- content-column-block end -->
				<h2>ビーチの記事一覧</h2>
				<ul class="post-list">
				<?php query_posts('cat=1&posts_per_page=9&paged='.$paged); ?>
				<?php while (have_posts()) : the_post();?>
					<a href="<?php the_permalink(); ?>">
						<li>
							...
							<p class="bottom">
								<span class="category category-beach">ビーチ</span>
